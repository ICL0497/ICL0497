...
<!-- Replace the link below with your own banner image or delete this block -->
...
- **Project One — Minimal Habit Tracker (iOS)**
  - SwiftUI · MVVM‑C · Local persistence · Haptics · Widgets  
  - <a href="https://github.com/YOUR_USERNAME/project-one">Repo</a> · <a href="https://YOUR_DEMO_LINK">Demo</a>

- **Project Two — Swift Concurrency Playground**
  - async/await · Task groups · Actors · Unit tests  
  - <a href="https://github.com/YOUR_USERNAME/project-two">Repo</a>

- **Project Three — Tiny Backend for iOS App**
  - Node/Express · REST · JWT · Dockerized dev  
  - <a href="https://github.com/YOUR_USERNAME/project-three">Repo</a>

> Want more? Check my pinned repositories below 👇
...
<p>
  <img src="https://streak-stats.demolab.com?user=ICL0497&theme=tokyonight" alt="GitHub Streak" height="160"/>
</p>
...
- **MVVM** keeps UI logic simple, **Coordinator** handles navigation.
